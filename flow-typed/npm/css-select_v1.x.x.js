// flow-typed signature: 13e05371fea8896644deb3e4ffe5f165
// flow-typed version: <<STUB>>/css-select_v1.2.0/flow_v0.56.0

declare module 'css-select' {
  declare type Predicate<Value> = (v: Value) => boolean;
  declare type Adapter<Node, ElementNode> = {
    /**
     *  is the node a tag?
     */
    ...
    */
     ...
     * of its children.
     */
    findOne(test: Predicate<ElementNode>, elems: Array<ElementNode>): ?ElementNode,
  ...
  declare type Options<Node, ElementNode> = {
    /**
  ...
  declare type CompiledQuery = (node: any) => boolean;
  declare type Query = string | CompiledQuery;
   ...
   *   * Adjacent (`+`)
   */
  declare export function compile(query: string): CompiledQuery;
   ...
   */
  declare export function selectAll<Node, ElementNode>(
    query: Query,
   ...
   */
  declare export function selectOne<Node, ElementNode>(
    query: Query,
    elems: Array<ElementNode> | ElementNode,
    options?: Options<Node, ElementNode>
  ): ElementNode | null;
  ...
  declare export function is<Node, ElementNode>(
    elem: ElementNode,
    query: Query,
    options?: Options<Node, ElementNode>
  ): boolean;
   ...
   * @see [CSSselect.compile] for supported selector queries.
   */
  declare export default selectAll<*, *>;
}
