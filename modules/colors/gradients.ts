...
// then scaling saturation outward. The inner and outer stops' ratio stays
// within the 0.78-0.94 band that the sampled fifteen span, maintaining visual
// consistency with the sampled family.
