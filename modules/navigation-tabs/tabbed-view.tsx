...
export function IosTabbedView<P extends ParamListBase, T extends ReturnType<typeof createCupertinoBottomTabNavigator<P>>>(
	Tabs: T,
	screens: readonly Tab<P>[],
): JSX.Element {
	return (
...
export function MaterialTabbedView<P extends ParamListBase, T extends ReturnType<typeof createMaterialBottomTabNavigator<P>>>(
	Tabs: T,
	screens: readonly Tab<P>[],
): JSX.Element {
	return (
