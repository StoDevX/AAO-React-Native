...
export function applyFiltersToItem<T extends object>(filters: FilterType<T>[], item: T): boolean {
...
export function applyFilter<T extends object>(filter: FilterType<T>, item: T): boolean {
