 ...
 * its `label` prop draws the button -- and a sheet's `BottomSheet` anchors its
 * own trigger `Button`, styled identically (see `./lib/trigger-modifiers`).
 * So this component only decides which presentation a filter gets, and
