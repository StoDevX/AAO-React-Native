...
export async function loadAllCourses(forceFromServer?: bool): Promise<{[key: string]: CourseType[]}> {
...
async function getAllCoursesFromServer(): Promise<{[key: string]: CourseType[]}> {
...
async function getAllCoursesFromStorage(): Promise<{[key: string]: CourseType[]}> {
...
async function getCourseList(term: number): Promise<CourseType[]> {
  ...
  try {
    ...
    return [{error: `Error loading ${term}.`}]
  }
}
