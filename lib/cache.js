...
export function setMealInfo(meals: {weekly: null|string, daily: null|string}) {
  return setItem(mealsKey, meals, mealsCacheTime)
}
export function getMealInfo(): CacheResultType<{weekly: null|string, daily: null|string}> {
