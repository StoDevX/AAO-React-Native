...
function rowToCourse(domRow: Object, term: string): CourseType {
  ...
  if (deptnum instanceof Error) {
    result.department = [deptnum.message]
    result.number = NaN
  } else {
...
function parseDeptNum(deptNumString: string): Error|{department: string[], number: number, section?: string} {
