...
export const BaseText = (props: TextProps): React.JSX.Element => (
...
export const Strong = (props: TextProps): React.JSX.Element => (
	<Text {...props} style={[styles.strong, props.style]} />
)

export const Emph = (props: TextProps): React.JSX.Element => (
