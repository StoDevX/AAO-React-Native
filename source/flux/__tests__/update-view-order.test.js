...
test(
  'it should return the current order if no screens have changed, even if sorted differently',
  () => {
...
test(
  'it should return the current order if no screens have changed, even if not sorted alphabetically',
  () => {
    let savedOrder = ['a', 'b', 'c']
...
test(
  'it should remove values from the given list when not present in the default list',
  () => {
    let savedOrder = ['d', 'b']
    let defaultOrder = ['a', 'b', 'c']
    let actual = updateViewOrder(savedOrder, defaultOrder)
...
test(
  'it should maintain the order of the given items when adding values',
  () => {
    let savedOrder = ['b']
    let defaultOrder = ['a', 'b', 'c']
    let actual = updateViewOrder(savedOrder, defaultOrder)
...
test(
  'it should maintain the order of the given items when removing values',
  () => {
