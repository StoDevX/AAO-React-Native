...
export const dayMoment = (time: string, format = 'ddd h:mma'): moment.Moment => {
...
export const hourMoment = (time: string): moment.Moment =>
	moment
...
export const plainMoment = (time: string, format: string): moment.Moment =>
