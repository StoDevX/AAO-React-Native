        ...
        <View style={styles.cellContainer}>
          <View style={styles.cellContent}>
            <View>
              ...
              {props.course.times && <Text><FormattedLine items={props.course.times} /></Text>}
              {props.course.instructors && <Text><FormattedLine items={props.course.instructors} /></Text>}
              {props.course.gereqs && <Text><FormattedLine items={props.course.gereqs} /></Text>}
            </View>
          </View>
