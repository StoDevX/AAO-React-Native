...
function Thumbnail({item}: {item: Movie}) {
	return item.thumb ? (
		<Image source={{uri: item.thumb}} style={styles.image} />
	) : null
}

export class MovieRow extends React.PureComponent {
	props: {stream: Movie}
